...
var CompositionHelper = (function () {
    ...
    CompositionHelper.prototype.iscomposingnow = function () {
...
},{"./core/Platform":21}],7:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var Terminal = (function (_super) {
    ...
    Terminal.prototype.scroll = function (isWrapped) {
        ...
        if (useRecycling) {
            ...
            if (!newLine ||
                ...
                newLine.get(0)[Buffer_1.CHAR_DATA_ATTR_INDEX] !== this.eraseAttr()) {
    ...
    Terminal.prototype.write = function (data) {
        ...
        if (this.options.useFlowControl &&
    ...
    Terminal.prototype._keyPress = function (ev) {
        ...
        var key2 = String.fromCharCode(key);
