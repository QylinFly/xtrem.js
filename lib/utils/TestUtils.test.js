...
var MockTerminal = (function () {
    ...
    MockTerminal.prototype.registerCharacterJoiner = function (handler) {
        return 0;
    };
...
var MockRenderer = (function () {
    ...
    MockRenderer.prototype.setTheme = function (theme) {
        return {};
    };
    ...
    MockRenderer.prototype.registerCharacterJoiner = function (handler) {
        return 0;
    };
    MockRenderer.prototype.deregisterCharacterJoiner = function () {
        return true;
    };
    return MockRenderer;
}());
...
var MockCompositionHelper = (function () {
    ...
    MockCompositionHelper.prototype.iscomposingnow = function () {
        throw new Error('Method not implemented.');
    };
